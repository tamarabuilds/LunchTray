...
class OrderViewModel : ViewModel() {
    ...
    fun setEntree(entree: String) {
        ...
        Log.d("set entre", "Here's what saved: entree = ${_entree.value?.price.toString()}")
    }
    ...
    fun setSide(side: String) {
        ...
        Log.d("set side", "Here's what saved: entree = ${_entree.value?.name.toString()}, " +
                "side = ${_side.value?.name.toString()}")
    }
    ...
    fun setAccompaniment(accompaniment: String) {
        ...
        Log.d("set accompaniment", "Here's what saved: entree = ${_entree.value?.name.toString()}, " +
                "side = ${_side.value?.name.toString()}, " +
                "accompaniment = ${_accompaniment.value?.name.toString()}")
    }
    ...
    private fun updateSubtotal(itemPrice: Double) {
        ...
        if (_subtotal.value != null) {
            (_subtotal.value!! + itemPrice).also { _subtotal.value = it }
        } else {
