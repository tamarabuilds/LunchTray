...
class CheckoutFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        Log.d("set checkout", "onCreateView set")
        return root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            Log.d("set checkout", "onViewCreated set")
            //Log.d("set viewCreated", "Here's what saved: entree = ${viewModel!!.entree.value!!.name.toString()}, " +
            //        "side = ${viewModel!!.side.value!!.name.toString()}, " +
            //        "accompaniment = ${viewModel!!.accompaniment.value!!.name.toString()}")
        }
    }
